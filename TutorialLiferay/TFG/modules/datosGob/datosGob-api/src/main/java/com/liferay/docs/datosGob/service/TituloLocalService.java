...
/**
 * Provides the local service interface for Titulo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author liferay
 * @see TituloLocalServiceUtil
...
public interface TituloLocalService extends BaseLocalService,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Titulo> getTitulos(long groupId, String datasetId, int start,
		int end) throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Titulo> getTitulos(long groupId, String datasetId, int start,
		int end, OrderByComparator<Titulo> obc);
