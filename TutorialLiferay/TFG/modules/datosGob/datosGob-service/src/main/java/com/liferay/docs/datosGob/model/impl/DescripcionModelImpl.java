...
public class DescripcionModelImpl extends BaseModelImpl<Descripcion>
	...
	public static final String TABLE_SQL_CREATE = "create table DB_Descripcion (uuid_ VARCHAR(75) null,groupId LONG,descripcionId LONG not null primary key,descripcion TEXT null,datasetId VARCHAR(500) null)";
