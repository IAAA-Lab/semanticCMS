...
/**
 * Provides the base implementation for the coleccion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.docs.datosGob.service.impl.ColeccionLocalServiceImpl}.
 * </p>
 *
 * @author liferay
 ...
 */
@ProviderType
public abstract class ColeccionLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ColeccionLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.docs.datosGob.service.ColeccionLocalServiceUtil} to access the coleccion local service.
	 */
	...
	public Coleccion addColeccion(Coleccion coleccion) {
		...
		return coleccionPersistence.update(coleccion);
	}
	...
	public Coleccion createColeccion(String homepage) {
		return coleccionPersistence.create(homepage);
	}
	...
	public Coleccion deleteColeccion(String homepage) throws PortalException {
		return coleccionPersistence.remove(homepage);
	}
	...
	public Coleccion deleteColeccion(Coleccion coleccion) {
		return coleccionPersistence.remove(coleccion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Coleccion.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return coleccionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return coleccionPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return coleccionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public Coleccion fetchColeccion(String homepage) {
		return coleccionPersistence.fetchByPrimaryKey(homepage);
	}
	...
	public Coleccion fetchColeccionByUuidAndGroupId(String uuid, long groupId) {
		return coleccionPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Coleccion getColeccion(String homepage) throws PortalException {
		return coleccionPersistence.findByPrimaryKey(homepage);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return coleccionLocalService.deleteColeccion((Coleccion)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return coleccionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public Coleccion getColeccionByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return coleccionPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Coleccion> getColeccions(int start, int end) {
		return coleccionPersistence.findAll(start, end);
	}
	...
	public int getColeccionsCount() {
		return coleccionPersistence.countAll();
	}
	 ...
	 */
	public ColeccionLocalService getColeccionLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.docs.datosGob.model.Coleccion",
			coleccionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.docs.datosGob.model.Coleccion");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ColeccionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = coleccionPersistence.getDataSource();
	...
	@BeanReference(type = ColeccionLocalService.class)
	protected ColeccionLocalService coleccionLocalService;
