...
public class GuestbookLocalServiceUtil {
	...
	*/
	...
	public static void mostrar(org.apache.jena.rdf.model.Model p) {
		getService().mostrar(p);
	}

	public static String toJSONLD(long groupId) {
		return getService().toJSONLD(groupId);
	}
