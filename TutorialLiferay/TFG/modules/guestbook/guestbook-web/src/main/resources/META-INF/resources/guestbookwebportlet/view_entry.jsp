...
<c:if test="<%=themeDisplay.isSignedIn()%>">
	...
	<liferay-ui:panel-container extended="<%=false%>"
		...
		<liferay-ui:panel collapsible="<%=true%>" extended="<%=true%>"
			...
			<%
				Discussion discussion = CommentManagerUtil.getDiscussion(user.getUserId(), scopeGroupId,
									Entry.class.getName(), entry.getEntryId(), new ServiceContextFunction(request));
			%>
